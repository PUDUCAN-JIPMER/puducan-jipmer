...
export default function NotFound() {
    return (
        <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-16 text-foreground">
            <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,_rgb(37_99_235)_0,_transparent_32%)] opacity-15" />
            <div className="absolute left-1/2 top-1/2 -z-10 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-500/10 blur-3xl" />
            ...
            <section className="w-full max-w-2xl rounded-3xl border border-border bg-card/95 p-8 text-center text-card-foreground shadow-xl backdrop-blur sm:p-12">
                <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-blue-500/10 text-blue-600 ring-8 ring-blue-500/5">
                    <AlertTriangle className="h-10 w-10" aria-hidden="true" />
                </div>

                <p className="mb-3 text-sm font-semibold uppercase tracking-[0.3em] text-blue-600">404 error</p>
                ...
                <div className="mt-8 flex justify-center">
                    <Button asChild size="lg" className="rounded-full bg-blue-600 px-7 text-white hover:bg-blue-700">
                        <Link href="/home">
