...
test.describe('Login Page (E2E)', () => {
    ...
    test('navigates to home page on link click', async ({ page }) => {
        await page.getByRole('link', { name: /click to go home/i }).click()
    ...
    test('redirects to dashboard after successful login', async ({ page }) => {
        ...
        await page.getByRole('button', { name: /sign in/i }).click()
        await expect(page).toHaveURL(/\/PuduCan\//, { timeout: 8000 })
    })
})
